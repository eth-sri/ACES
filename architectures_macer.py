'''
- this file contains the neccessary architectures for the MACER trained ResNets
- it is based on the publicly available code from: https://github.com/RuntianZ/macer/blob/master/model.py written by Runtian Zhai
'''
